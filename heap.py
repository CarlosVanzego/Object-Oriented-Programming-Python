...
# Min Heap: In a Min Heap, the key of each node is always smaller than the keys of its child nodes, resulting in the root node's key being the smallest in the heap. 