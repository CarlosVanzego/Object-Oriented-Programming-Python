...
# 
# Classes and Objects:
# Since Python is an object oriented programming language, almost everything in Python is an object with its own set of attributes and method. A Class is an object constructor or a blueprint for creating objects
class sampleClass:
  word = "HelLo"

sampleObject = sampleClass()
print(sampleObject.word)  
...
studentObject = Student("Carlos", 28)
