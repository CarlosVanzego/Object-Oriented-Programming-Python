...
# What this all means is that everything in Python is an Object of some type of Class.
# These are called "built-in" types these are built into the python language; They work differntly than normal classes.
# Whenever you create something in Python, you are really creating an Object, which is an instance of a specific Class; That Class defines the way the Object can interact with other things in the program.
