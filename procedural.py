...
# Get input values 
# I am setting the variable 'length_input' equal to the float class, then passing the input function and the "Enter length: " string that will show in the terminal to allow the user to input a length for calculation.
