...
# "if" key word:
# In this example, I use two variables, c and v, which are used as part of the if statements to test whether v is greater than c. As c is 400, and v is 7 we know that 400 is greater than 7, and so we print that "c is gdsareaqreater than v"
