...
# Functionality:
# It counts the occurence of each elements in an iterable (like lists, strings) and stores them as dictionary keys, with the counts as their corresponding value
# 
