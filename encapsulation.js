...
// This is better because the 'getWage' function has no parameters. In the procedural example the same fucntion had 3 parameters; In the OOP example all 3 of the original paramters are no modeled as properties of the 1 employee object; All the properties, and the getWage function are related, so they are a part of one unit.
