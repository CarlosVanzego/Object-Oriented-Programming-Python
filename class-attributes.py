...
class Person:
  ...
  number_of_people = 0
  # this line initializes the function with the arguments self and name.
  # Contstructor method that initializes an instance with a name attribute.
  def __init__(self, name):
      self.name = name
# This is a variable I called p1 and assigned an instance of the Person class with the string "Harold"
# I created a new instance of the Person Class with the name Harold.
p1 = Person("Harold")
# ?
print(p1)
